...
class MappaPageState extends State<Mappa> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Mappa di Roma'), actions: [
        IconButton(
          icon: Image.asset(
          ...
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => Mappa()));
          },
        ),
        IconButton(
          icon: Image.asset(
          ...
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => MappaEng()));
          },
        ),
      ]),
      body: FlutterMap(
...
class MappaEng extends StatefulWidget {
  const MappaEng({super.key});

  @override
  State<MappaEng> createState() => MappaPageStateEng();
}

class MappaPageStateEng extends State<MappaEng> {
  // Coordinate GPS di Roma Termini e Colosseo
  final LatLng RomaTermini = LatLng(41.9028, 12.4964); // Roma Termini
  final LatLng Colosseo = LatLng(41.8902, 12.4922); // Colosseo
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Map of Rome'), actions: [
        IconButton(
          icon: Image.asset(
            'assets/images/it.png', // Percorso dell'immagine
            width: 24, // Larghezza desiderata dell'immagine
