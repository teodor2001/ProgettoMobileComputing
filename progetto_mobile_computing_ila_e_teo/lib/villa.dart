              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.of(context)
                      .push(MaterialPageRoute(builder: (context) => Villa()));
                },
              ),
              IconButton(
                icon: Image.asset(
                ...
                onPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => VillaEng()));
                },
              ),
            ]),
...
class VillaEng extends StatelessWidget {
  const VillaEng({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Color.fromARGB(255, 188, 160, 230),
          ...
          child: Column(children: [
            Center(
              child: Container(
                ...
                child: Text(
                  "Villa Borghese is a large city park that includes various green areas, from Italian-style gardens to extensive English-style areas, buildings, small structures, fountains, and small lakes. You can stroll through the park, rent bicycles or rickshaws, take a boat ride on the characteristic lake, and enjoy the view of Rome from the famous Pincio Terrace overlooking Piazza del Popolo. It's a highly suitable attraction for families.",
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
                    fontSize: 20,
